...
public class MyResource {
	...
	// curl: curl -X POST
	// http://localhost:8080/simple-service-webapp/webapi/myresource/abc
	...
	// curl: curl --data 'some data'
	// http://localhost:8080/simple-service-webapp/webapi/myresource/post
	...
	// curl: curl -i
	// http://localhost:8080/simple-service-webapp/webapi/myresource/getTrack
	@GET
	@Path("/getTrack")
	...
	// Reads and Writes Cookie data
	@GET
	@Path("/getCookie")
	@Produces(MediaType.APPLICATION_JSON)
	public Response getCookie(@CookieParam(value = "NewSessionID") String newSessionID) {

		AppID appID = new AppID();
		appID.setAppID(APP_ID.toString());

		return Response.ok().entity(appID).cookie(new NewCookie("NewSessionID", "4545" + newSessionID)).build();

	}

	// get example returning JSON
	// curl: curl -i
	// http://localhost:8080/simple-service-webapp/webapi/myresource/getTracks
	@GET
	@Path("/getTracks")
	@Produces(MediaType.APPLICATION_JSON)
	...
	// get example returning JSON
	// curl: curl -i
	// http://localhost:8080/simple-service-webapp/webapi/myresource/getURLs
	@GET
	@Path("/getURLs")
	@Produces(MediaType.APPLICATION_JSON)
	...
	// get example returning JSON
	// curl: curl -i
	// http://localhost:8080/simple-service-webapp/webapi/myresource/getLandingPage
	@GET
	@Path("/getLandingPage")
	...
	// cd ../instructions
	// curl: curl -X POST -d @track.txt
	// http://localhost:8080/simple-service-webapp/webapi/myresource/postTrack
	...
	public Response downloadFile() {
		...
		return Response.ok(fileStream, MediaType.APPLICATION_OCTET_STREAM)
				.header("content-disposition", "attachment; filename = downloaded-test.txt").build();
	}
